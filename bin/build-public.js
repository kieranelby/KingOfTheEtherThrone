...
if (publishEnabled) {
  ...
  console.log("Copying to webserver in original subdir");

  child_process.exec("rsync -r -t -z -e ssh public/ obpapp@newvm.el.by:/usr/share/nginx/html/original", {timeout:60000});
